...
export default function Home() {
  return (
    <>
      ...
      {/* ===================== HERO ===================== */}
      <section className="container text-left mx-auto">
      ...
      {/* ===================== ANTES Y DESPUÉS ===================== */}
      <section className="" id="antes-despues">
      ...
      <section className="section section-alt" id="ruge">
        <div className="container ruge-content-full">
          ...
          <ul className="check-list">
            <li> Plan de pérdida de peso personalizado</li>
        ...
        <div className="container">
          <div className="programa-content">
            ...
            <p className="section-lead">
              ...
              darte las herramientas y el acompañamiento para que dentro de 12
              meses ya no me necesites.
            </p>
            ...
            <div className="fit-grid">
              ...
              <div className="fit-card fit-yes">
                ...
                <p>
                  Estás dispuesto a mirar hacia adentro, trabajar tus emociones
                  y comprometerte con tu mejor versión.
                </p>
              </div>
            </div>

            <p className="carousels-intro">
              Mira cómo ha cambiado mi vida e imagina todo lo que puedes
              conseguir si empiezas ahora:
            </p>
          </div>
