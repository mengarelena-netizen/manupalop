...
export default function FinalCtaSection() {
  return (
    <section className="bg-brand py-24 text-center">
      <Container>
        <h2 className="mx-auto mt-0 mb-3 max-w-[720px] text-on-brand">
          Tu cambio empieza hoy.
        </h2>
        <p className="mx-auto mt-0 mb-8 max-w-[640px] font-sans text-[20px] font-medium text-on-brand not-italic">
